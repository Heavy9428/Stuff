	...
	<div class="w3-container w3-padding-16">
		...
		<div class="w3-quarter w3-container w3-border w3-border-green">
			...
			<%
					...
					String query ="Select DISTINCT Order_id from Order_ID where ID="+ID;
					...
					<a href = "http://localhost:8080/PetShop/MyOrders.jsp?value=<%=rs.getString("order_id")%>"><%=rs.getString("order_id")%></a>
					<%
